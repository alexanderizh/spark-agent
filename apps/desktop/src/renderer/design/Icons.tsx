...
export const Icons = {
  ...
  FolderOpen: (p: IconProps) => <IconBase {...p}><path d="M3 8a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v1H7.6a2 2 0 0 0-1.8 1.1L3 18.5V8z" /><path d="M3 18.5 5.8 12a2 2 0 0 1 1.8-1h13a1.4 1.4 0 0 1 1.3 1.9l-2 5A2 2 0 0 1 18 19H4.1a1.2 1.2 0 0 1-1.1-.5z" /></IconBase>,
  ProjectFolder: (p: IconProps) => <IconBase {...p}><path d="M3 7a2 2 0 0 1 2-2h4l2 2h7a2 2 0 0 1 2 2v3.2" /><path d="M3 7v10a2 2 0 0 0 2 2h6.2" /><path d="M14 15v4" /><circle cx="14" cy="14" r="1.2" /><circle cx="14" cy="20" r="1.2" /><circle cx="20" cy="17" r="1.2" /><path d="M15.2 15.2 18.8 17 15.2 18.8" /></IconBase>,
  ...
  FilePlus: (p: IconProps) => <IconBase {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /><path d="M12 12v6M9 15h6" /></IconBase>,
  FileMinus: (p: IconProps) => <IconBase {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /><path d="M9 15h6" /></IconBase>,
