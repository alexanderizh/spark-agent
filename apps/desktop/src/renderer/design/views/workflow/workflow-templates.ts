...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
      ...
      nodes: [
        {
          ...
          y: 160,
          config: {
            prompt: '解析用户需求，提炼目标、约束和交付物，作为后续节点的输入。',
            outputKey: 'objective',
            retryCount: 1,
          },
        },
        {
          ...
          x: 360,
          y: 160,
          config: { prompt: '基于目标拆解可执行的实施步骤。', outputKey: 'plan' },
        },
        {
          id: 'agent-1',
          kind: 'agent',
          ...
          x: 640,
          y: 160,
          config: { prompt: '按计划完成实现，记录关键决策与改动。', outputKey: 'implementation' },
        },
        {
          id: 'verify-1',
          kind: 'verify',
        ...
        },
        {
          ...
          x: 1200,
          y: 160,
          config: { prompt: '整理交付物、变更摘要和后续建议。', outputKey: 'deliverable' },
        },
      ],
      edges: [
      ...
      nodes: [
        {
          ...
          x: 80,
          y: 160,
          config: { prompt: '解析需求与交付物。', outputKey: 'objective', retryCount: 1 },
        },
        {
          id: 'plan-1',
          kind: 'plan',
          ...
          x: 340,
          y: 160,
          config: { prompt: '拆解实施步骤，供审批参考。', outputKey: 'plan' },
        },
        {
          id: 'approval-1',
          kind: 'approval',
          ...
          y: 160,
          config: {
            prompt: '请审批以下计划是否进入执行；拒绝将终止工作流，批准可附修改意见。',
            outputKey: 'approval',
          },
        },
        {
          ...
          x: 860,
          y: 160,
          config: { prompt: '按审批通过的计划完成实现。', outputKey: 'implementation' },
        },
        {
          id: 'verify-1',
          kind: 'verify',
        ...
        },
        {
          ...
          x: 1380,
          y: 160,
          config: { prompt: '整理交付物与变更摘要。', outputKey: 'deliverable' },
        },
      ],
      edges: [
        { id: 'e-input-plan', from: 'input-1', to: 'plan-1' },
    ...
    graph: {
      nodes: [
        ...
        },
        {
          ...
          y: 160,
          config: {
            prompt: '针对目标并行产出 3 路独立草案，分别采用不同角度或方案。结果会按分支拼接。',
            outputKey: 'drafts',
            parallelism: 3,
          },
        },
        {
          ...
          x: 640,
          y: 160,
          config: { prompt: '对比 3 路草案的优劣，给出推荐方案与理由。', outputKey: 'synthesis' },
        },
        {
          id: 'artifact-1',
          kind: 'artifact',
          ...
          x: 920,
          y: 160,
          config: { prompt: '输出最终推荐方案。', outputKey: 'recommendation' },
        },
      ],
      edges: [
      ...
      nodes: [
        {
          ...
          x: 80,
          y: 160,
          config: { prompt: '解析调研主题、范围与交付物。', outputKey: 'topic', retryCount: 1 },
        },
        {
          id: 'review-1',
          kind: 'review',
          ...
          x: 360,
          y: 160,
          config: { prompt: '围绕主题做只读调研，汇总关键信息与来源。', outputKey: 'research' },
        },
        {
          id: 'review-2',
          kind: 'review',
        ...
        },
        {
          ...
          y: 160,
          config: {
            prompt: '整理为 Markdown 报告。',
            outputKey: 'report',
            exportPath: 'docs/research-report.md',
          },
        },
      ],
      edges: [
      ...
      nodes: [
        {
          ...
          x: 80,
          y: 160,
          config: { prompt: '解析目标与交付物。', outputKey: 'objective', retryCount: 1 },
        },
        {
          id: 'skill-1',
          kind: 'skill',
          ...
          x: 360,
          y: 160,
          config: { prompt: '按所选 Skill 的方法与约束处理任务。', outputKey: 'skill_output' },
        },
        {
          id: 'review-1',
          kind: 'review',
          ...
          x: 640,
          y: 160,
          config: { prompt: '复核 Skill 产出的结果。', outputKey: 'review' },
        },
        {
          id: 'artifact-1',
          kind: 'artifact',
          ...
          x: 920,
          y: 160,
          config: { prompt: '整理最终交付物。', outputKey: 'deliverable' },
        },
      ],
      edges: [
  ...
  // 6. 工具调用流 —— tool 节点示范确定性直调（内置工具 + 参数）与 {{key}} 变量引用
  {
    id: 'tool-invocation',
    name: '工具调用流',
    description:
      '计划后按指定工具与参数确定性执行，再验证交付。tool 节点支持内置工具/MCP 工具直调与 {{outputKey}} 变量。',
    tags: ['工具', '验证'],
    needsBinding: '按需调整工具节点的执行模式与调用参数；执行节点需绑定 Agent',
    graph: {
      nodes: [
        {
          id: 'input-1',
        ...
        },
        {
          ...
          x: 340,
          y: 160,
          config: { prompt: '拆解需要调用哪些工具、按什么顺序。', outputKey: 'plan' },
        },
        {
          id: 'tool-1',
          kind: 'tool',
          ...
          config: {
            ...
            toolSource: 'builtin',
            toolName: 'Bash',
            toolArgs: { command: 'echo {{objective}}' },
          },
        },
        {
          id: 'verify-1',
        ...
        },
        {
          ...
          x: 1120,
          y: 160,
          config: { prompt: '整理 {{tool_output}} 形成交付物。', outputKey: 'deliverable' },
        },
      ],
      edges: [
        { id: 'e-input-plan', from: 'input-1', to: 'plan-1' },
  ...
  // 7. MCP 外部能力流 —— mcp 节点缺省受限代理（挂载全部已启用 MCP），
  //    在检查器切「MCP 工具直调」可绑定 server+tool+参数，确定性调用不经 LLM。
  {
    id: 'mcp-integration',
    name: 'MCP 外部能力流',
    description:
      '通过已启用的 MCP 服务完成外部能力调用，再经复核产出交付物；检查器可切换为 MCP 工具直调。',
    tags: ['MCP', '外部'],
    graph: {
      nodes: [
        {
        ...
        },
        {
          ...
          y: 160,
          config: {
            prompt: '使用已启用的 MCP 服务完成外部能力调用，记录响应。',
            outputKey: 'mcp_output',
          },
        },
        {
          id: 'review-1',
          ...
          x: 640,
          y: 160,
          config: { prompt: '复核 MCP 返回结果是否满足需求。', outputKey: 'review' },
        },
        {
          id: 'artifact-1',
          kind: 'artifact',
  ...
  // 8. 条件路由流 —— route 决策 equals，二分支独立终点
  {
    ...
    name: '条件路由流',
    description:
      '路由节点从 routeOptions 中选择 deep/quick，条件边 equals 路由到两条独立支线，各产各的交付物。',
    tags: ['条件分支', '路由'],
    ...
    graph: {
      nodes: [
        ...
        },
        {
          ...
          x: 640,
          y: 60,
          config: { prompt: '按计划完成完整实现。', outputKey: 'implementation' },
        },
        {
          id: 'verify-1',
          kind: 'verify',
        ...
        },
        {
          ...
          x: 1160,
          y: 60,
          config: { prompt: '整理完整实现交付物。', outputKey: 'deliverable_deep' },
        },
        {
          id: 'review-1',
          kind: 'review',
          ...
          x: 640,
          y: 320,
          config: { prompt: '产出快速摘要。', outputKey: 'summary' },
        },
        {
          id: 'artifact-quick',
          kind: 'artifact',
          ...
          x: 900,
          y: 320,
          config: { prompt: '整理摘要交付物。', outputKey: 'deliverable_quick' },
        },
      ],
      edges: [
  ...
  // 9. 复核门禁流 —— review 决策 equals，通过则执行、驳回则产驳回报告
  {
    ...
    name: '复核门禁流',
    description:
      '复核节点对计划严格输出 approve/reject，条件边 equals 路由：通过则执行交付，驳回则直接产出驳回报告。',
    tags: ['条件分支', '复核'],
    ...
    graph: {
      nodes: [
        ...
        },
        {
          ...
          x: 340,
          y: 160,
          config: { prompt: '拆解实施步骤。', outputKey: 'plan' },
        },
        {
          id: 'review-1',
          kind: 'review',
          ...
          config: {
            prompt:
              "复核计划可行性，严格只输出 'approve'（通过）或 'reject'（驳回）一个词，不要输出其他内容。",
            outputKey: 'verdict',
          },
        },
        {
          ...
          x: 860,
          y: 60,
          config: { prompt: '按通过的计划完成实现。', outputKey: 'implementation' },
        },
        {
          id: 'artifact-pass',
          kind: 'artifact',
          ...
          x: 1120,
          y: 60,
          config: { prompt: '整理交付物。', outputKey: 'deliverable_pass' },
        },
        {
          id: 'artifact-reject',
          kind: 'artifact',
          ...
          x: 860,
          y: 320,
          config: { prompt: '说明计划被驳回的原因与改进建议。', outputKey: 'deliverable_reject' },
        },
      ],
      edges: [
        { id: 'e-input-plan', from: 'input-1', to: 'plan-1' },
        { id: 'e-plan-review', from: 'plan-1', to: 'review-1' },
        {
          ...
          from: 'review-1',
          to: 'agent-1',
          condition: { op: 'equals', key: 'verdict', value: 'approve' },
        },
        { id: 'e-agent-artifact-pass', from: 'agent-1', to: 'artifact-pass' },
        {
          id: 'e-review-artifact-reject',
          from: 'review-1',
          to: 'artifact-reject',
          condition: { op: 'equals', key: 'verdict', value: 'reject' },
        },
      ],
    },
  },
  ...
  // 10. 调研决策流 —— review 调研后 equals 决策，推进或暂缓各产独立产物
  {
    ...
    name: '调研决策流',
    description:
      '只读调研后由复核节点严格输出 go/hold 决策，条件边 equals 路由：推进则计划+执行+交付，暂缓则直接出暂缓报告。',
    tags: ['条件分支', '调研'],
      ...
      nodes: [
        {
          ...
          x: 80,
          y: 160,
          config: { prompt: '解析需要调研决策的主题。', outputKey: 'topic', retryCount: 1 },
        },
        {
          id: 'review-1',
          kind: 'review',
          ...
          config: {
            prompt:
              "围绕主题做只读调研后给出决策建议，严格只输出 'go'（建议推进）或 'hold'（建议暂缓）一个词，不要输出其他内容。",
            outputKey: 'decision',
          },
        },
        {
          ...
          x: 600,
          y: 60,
          config: { prompt: '制定推进计划。', outputKey: 'plan' },
        },
        {
          id: 'agent-1',
          kind: 'agent',
          ...
          x: 860,
          y: 60,
          config: { prompt: '按计划执行。', outputKey: 'implementation' },
        },
        {
          id: 'artifact-go',
          kind: 'artifact',
          ...
          x: 1120,
          y: 60,
          config: { prompt: '整理推进交付物。', outputKey: 'deliverable_go' },
        },
        {
          id: 'artifact-hold',
          kind: 'artifact',
          ...
          x: 600,
          y: 320,
          config: { prompt: '说明建议暂缓的理由与后续触发条件。', outputKey: 'deliverable_hold' },
        },
      ],
      edges: [
        { id: 'e-input-review', from: 'input-1', to: 'review-1' },
        {
          ...
          from: 'review-1',
          to: 'plan-1',
          condition: { op: 'equals', key: 'decision', value: 'go' },
        },
        { id: 'e-plan-agent', from: 'plan-1', to: 'agent-1' },
        { id: 'e-agent-artifact-go', from: 'agent-1', to: 'artifact-go' },
        {
          id: 'e-review-artifact-hold',
          from: 'review-1',
          to: 'artifact-hold',
          condition: { op: 'equals', key: 'decision', value: 'hold' },
        },
      ],
    },
  },
  ...
  // 11. 跨职能团队协作 —— 多成员 Agent 角色分工 + subagent 并行 fan-out + 评审门禁条件分支
  {
    ...
    name: '跨职能团队协作',
    description:
      'PM、架构师、工程负责人多个成员 Agent 串行协作，subagent 并行实现三路，评审门禁条件路由交付或返工。',
    tags: ['团队', '编排', '并行', '条件分支'],
      ...
      nodes: [
        {
          ...
          y: 160,
          config: {
            prompt: '解析用户需求，提炼目标、验收标准与交付物，作为团队协作的起点。',
            outputKey: 'objective',
            retryCount: 1,
          },
        },
        {
          ...
          y: 160,
          config: {
            prompt: '作为产品负责人拆解需求：用户故事、优先级、验收标准与风险点。',
        ...
        },
        {
          ...
          y: 160,
          config: {
            prompt: '作为架构师基于需求产出技术方案：模块划分、接口契约、关键决策与依赖。',
            outputKey: 'design',
          },
        },
        {
          ...
          config: {
            prompt:
              '按技术方案并行产出 3 路实现，分别覆盖前端、后端、工具链/脚本，互不阻塞。结果会按分支拼接。',
        ...
        },
        {
          ...
          y: 160,
          config: {
            prompt: '作为工程负责人集成三方并行产出，处理冲突、补齐集成测试并记录改动摘要。',
        ...
        },
        {
          ...
          config: {
            prompt:
              "对集成结果做只读评审，严格只输出 'pass'（通过交付）或 'fail'（需返工）一个词，不要输出其他内容。",
            outputKey: 'verdict',
          },
        },
        {
          ...
          x: 1640,
          y: 80,
          config: { prompt: '整理最终交付物、变更摘要与后续建议。', outputKey: 'deliverable' },
        },
        {
          id: 'artifact-rework',
          kind: 'artifact',
          ...
          y: 300,
          config: {
            prompt: '说明评审未通过的问题、责任成员与返工建议。',
            outputKey: 'rework_report',
          },
        },
      ],
      edges: [
        ...
        { id: 'e-int-review', from: 'agent-integrator', to: 'review-1' },
        {
          ...
          from: 'review-1',
          to: 'artifact-deliver',
          condition: { op: 'equals', key: 'verdict', value: 'pass' },
        },
        {
          id: 'e-review-rework',
          from: 'review-1',
          to: 'artifact-rework',
          condition: { op: 'equals', key: 'verdict', value: 'fail' },
        },
      ],
    },
  },
  ...
  // 所以集成节点的入边全部满足、不会被 collectWorkflowInactiveNodeIds 标 inactive（安全）。
  {
    ...
    name: '主持人调度并行开发',
    description:
      '团队模式下主持人 Agent 的典型编排：先拆解任务分派给前端、后端、质量三个成员 Agent 并行开发，再由主持人集成并评审，通过则交付、需返工则产出返工任务清单。',
      ...
      nodes: [
        {
          ...
          y: 200,
          config: {
            prompt: '解析用户需求，提炼目标、验收标准与并行开发约束，作为主持人调度的起点。',
            outputKey: 'objective',
            retryCount: 1,
          },
        },
        {
          id: 'agent-host-dispatch',
          kind: 'agent',
          title: '主持人·任务拆解',
          x: 340,
          y: 200,
          config: {
            prompt:
              '作为主持人将需求拆解为可并行分配的子任务：明确前端、后端、质量三个成员的职责边界、接口契约与验收标准，确保三方互不阻塞。',
            outputKey: 'task_breakdown',
          },
        },
        {
          id: 'subagent-frontend',
          kind: 'subagent',
          title: '前端成员',
          x: 620,
          y: 60,
          config: {
            prompt: '作为前端成员按主持人分配的职责完成 UI 与交互实现，遵守与后端约定的接口契约。',
        ...
        },
        {
          ...
          config: {
            prompt:
              '作为后端成员按主持人分配的职责完成 API 与数据层实现，遵守与前端约定的接口契约。',
        ...
        },
        {
          ...
          y: 340,
          config: {
            prompt: '作为质量成员按主持人分配的职责产出测试用例与验收清单，覆盖前后端关键路径。',
            outputKey: 'qa_result',
          },
        },
        {
          id: 'agent-host-integrate',
          kind: 'agent',
          title: '主持人·集成',
          x: 900,
          y: 200,
          config: {
            prompt:
              '作为主持人集成前端、后端、质量三方并行产出，处理接口对齐与冲突，记录集成改动摘要。',
            outputKey: 'integration',
          },
        },
        {
          ...
          config: {
            prompt:
              "作为主持人对集成结果做只读评审，严格只输出 'pass'（通过交付）或 'rework'（需返工）一个词，不要输出其他内容。",
            outputKey: 'verdict',
          },
        },
        {
          ...
          x: 1420,
          y: 100,
          config: { prompt: '整理最终交付物、集成摘要与后续建议。', outputKey: 'deliverable' },
        },
        {
          id: 'artifact-rework',
          kind: 'artifact',
          ...
          y: 340,
          config: {
            prompt: '产出返工任务清单：按成员列出未达标项、责任人与返工要求，供主持人重新分派。',
            outputKey: 'rework_plan',
          },
        },
      ],
      edges: [
        ...
        },
        {
          ...
          from: 'review-host',
          to: 'artifact-rework',
          condition: { op: 'equals', key: 'verdict', value: 'rework' },
        },
      ],
    },
  },
  ...
  // 13. 迭代润色直到通过 —— loop 作为原子节点递归执行循环体子图，满足 breakCondition 即退出
  {
    ...
    name: '迭代润色直到通过',
    description:
      '需求输入后进入 loop：每轮产出改进稿并做通过/重试判断，最多 5 轮，满足 verdict=pass 即交付最后一稿。',
    tags: ['循环', '迭代', '复核'],
    graph: {
      nodes: [
        {
              ...
              nodes: [
                {
                  ...
                  y: 120,
                  config: {
                    prompt: '基于目标、上一轮反馈和当前轮次，生成一版更好的稿件。',
                    outputKey: 'draft',
                  },
                },
                {
                  ...
                  y: 120,
                  config: {
                    prompt: "评审本轮 draft 是否满足验收标准。严格只输出 'pass' 或 'retry'。",
                    outputKey: 'verdict',
                  },
                },
              ],
        ...
        },
        {
          ...
          x: 640,
          y: 160,
          config: { prompt: '整理 loop 输出的最终稿，并补充迭代摘要。', outputKey: 'deliverable' },
        },
      ],
      edges: [
