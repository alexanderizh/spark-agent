...
function CanvasStageInner({
  ...
  /** 图片节点/图片任务右键/工具栏 → 尺寸与压缩弹窗（sharp 处理，物化新子节点） */
  onImageScaleCompress?: (nodeId: string) => void
  ...
  const nodeActions = useMemo<CanvasNodeActions>(
    () => ({
      ...
      ...(onImageScaleCompress ? { scaleCompressImage: onImageScaleCompress } : {}),
