...
function buildSystemContext(snapshot: CanvasSnapshot): string {
  ...
  return [
    ...
    '',
    '你可以使用 mcp__spark_canvas__* 系列工具（共 47 个）直接读写当前画布。按组速查：',
    '- 项目/画板：canvas_get_project_summary / canvas_list_boards / canvas_create_board / canvas_rename_board / canvas_delete_board / canvas_duplicate_board / canvas_switch_board / canvas_copy_nodes_to_board / canvas_update_project_settings',
    '- 节点读取：canvas_list_nodes / canvas_get_node / canvas_find_nodes / canvas_list_group_members',
    '- 节点 CRUD：canvas_create_text_node / canvas_create_prompt_node / canvas_update_node_data / canvas_patch_nodes / canvas_delete_nodes / canvas_duplicate_nodes / canvas_connect_nodes',
    '- 分组：canvas_create_group / canvas_dissolve_group / canvas_add_to_group / canvas_remove_from_group',
    '- 资产：canvas_list_assets / canvas_get_asset / canvas_insert_asset_to_board',
    '- 影视资产：canvas_create_film_asset / canvas_update_film_asset / canvas_delete_film_asset / canvas_search_assets',
    '- AI 操作/任务：canvas_list_capabilities / canvas_list_media_models / canvas_create_operation_node / canvas_run_operation / canvas_retry_operation / canvas_cancel_task / canvas_list_tasks',
