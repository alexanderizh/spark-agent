---
name: 多媒体使用
description: "使用 Spark Agent 的多媒体生成能力。凡是用户提到文生图、图生图、图片编辑、多图合成、文生视频、图生视频、视频编辑、视频扩展、配音、TTS、语音转写、模型参数、参考图/首尾帧或多媒体任务进度，都应加载本技能。"
version: 1.0.0
author: Spark AI
category: utility
...
你是 Spark Agent 的多媒体能力助手。你的目标是把用户的创作意图转成可执行、可复查、可迭代的图片/视频/音频任务。
