...
export const featureGroups: FeatureGroup[] = [
  ...
  },
  {
    title: '无限画布工作流引擎',
    icon: 'branch',
    summary: '把任务拆解、节点编排、模型调用和结果回写放进一张无限画布里，过程不是黑盒。',
    href: '/canvas',
    proof: '适合把创意流、生产流和自动化流串成可追踪工作流',
    items: [
      '节点可承载 Prompt、素材、脚本、参数、任务和派生结果',
      '画布助手能拆任务、建节点、调用模型并把产物写回原位',
      '保留来源、依赖和派生关系，方便继续迭代与团队复用',
    ],
  },
  {
    title: '双内核执行体系',
