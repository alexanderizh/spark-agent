...
export const featureGroups: FeatureGroup[] = [
  ...
  },
  {
    title: '调试模式与内置工具链',
    icon: 'canvas',
    summary: '每条会话自动挂载十多类内置 MCP 工具，任意模型供应商下都能稳定调用，定位问题不靠猜。',
    href: '/features#tools',
    proof: '适合不希望「换一个模型供应商就少一半能力」、要排查前后端问题的团队',
    items: [
      '联网搜索 spark_search、文件卡片 spark_files、HTML/思维导图渲染 spark_ui 跨 provider 可用',
      '内置浏览器 spark_browser、桌面 Computer Use、画布 spark_canvas、长期记忆 spark_memory 即配即用',
      '调试模式把执行过程、诊断信息和关键状态暴露给使用者，排查、验证和修复在一处闭环',
    ],
  },
  {
    title: '项目资产表与知识沉淀',
  ...
  },
  {
    title: '会话定时任务与无人值守',
    icon: 'schedule',
    summary: '在单个会话里设 interval / cron / once 三类定时任务，到点自动用本会话当时的 Agent、模型、权限和工作区续接一轮对话。',
    href: '/docs/session-scheduled-tasks',
    proof: '适合轮询长任务、定时跟进和未来某刻的单次提醒',
    items: [
