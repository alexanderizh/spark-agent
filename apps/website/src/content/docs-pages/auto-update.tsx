...
const Body = () => (
  <>
    ...
    <ul>
      ...
      <li>运行期间约每 30 分钟静默检查一次，并加入 25～35 分钟随机抖动，避免客户端集中请求。</li>
      <li>自动检查失败时不弹出用户提示，并按约 1 小时、最多约 2 小时退避；手动检查失败仍会显示错误。</li>
      <li>窗口重新聚焦或系统从睡眠恢复时，如果上次检查已超过 30 分钟，会立即补做一次检查。</li>
