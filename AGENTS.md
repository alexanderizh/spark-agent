...
This project is indexed by GitNexus as **spark-agent** (16326 symbols, 29940 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
