...
This project is indexed by GitNexus as **spark-agent** (51021 symbols, 90578 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
