...
This project is indexed by GitNexus as **spark-agent** (11559 symbols, 25600 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
