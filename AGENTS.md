...
This project is indexed by GitNexus as **spark-agent** (5360 symbols, 10694 relationships, 250 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
