...
This project is indexed by GitNexus as **spark-agent** (9655 symbols, 22168 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
