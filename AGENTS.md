...
This project is indexed by GitNexus as **spark-agent** (5174 symbols, 10513 relationships, 294 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
