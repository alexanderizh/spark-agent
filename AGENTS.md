...
This project is indexed by GitNexus as **spark-agent** (21010 symbols, 37609 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
