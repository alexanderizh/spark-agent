...
This project is indexed by GitNexus as **spark-agent** (86869 symbols, 163459 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
