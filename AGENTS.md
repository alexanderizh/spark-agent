...
This project is indexed by GitNexus as **spark-agent** (68252 symbols, 123167 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
