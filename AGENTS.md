...
This project is indexed by GitNexus as **spark-agent** (40958 symbols, 71972 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
