...
This project is indexed by GitNexus as **spark-agent** (4935 symbols, 9910 relationships, 250 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
