...
This project is indexed by GitNexus as **spark-agent** (19681 symbols, 35307 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
