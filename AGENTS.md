...
This project is indexed by GitNexus as **spark-agent** (62227 symbols, 110733 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
