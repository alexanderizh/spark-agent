...
This project is indexed by GitNexus as **spark-agent** (40094 symbols, 70704 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
