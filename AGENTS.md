...
This project is indexed by GitNexus as **spark-agent** (49637 symbols, 88405 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
