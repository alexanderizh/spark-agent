...
This project is indexed by GitNexus as **spark-agent** (60585 symbols, 108331 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
