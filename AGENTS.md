...
This project is indexed by GitNexus as **spark-agent** (45450 symbols, 79350 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
