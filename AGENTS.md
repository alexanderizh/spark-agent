...
This project is indexed by GitNexus as **spark-agent** (85914 symbols, 161146 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
