...
This project is indexed by GitNexus as **spark-agent** (69799 symbols, 126288 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
