...
This project is indexed by GitNexus as **spark-agent** (21683 symbols, 38827 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
