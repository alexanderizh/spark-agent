...
This project is indexed by GitNexus as **spark-agent** (19315 symbols, 34597 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
