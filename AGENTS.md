...
This project is indexed by GitNexus as **spark-agent** (36865 symbols, 62977 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
