...
This project is indexed by GitNexus as **spark-agent** (23842 symbols, 42423 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
