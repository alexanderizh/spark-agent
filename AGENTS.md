...
This project is indexed by GitNexus as **spark-agent** (34800 symbols, 59370 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
