...
This project is indexed by GitNexus as **spark-agent** (45087 symbols, 78683 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
