...
This project is indexed by GitNexus as **spark-agent** (53941 symbols, 96030 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
