...
This project is indexed by GitNexus as **spark-agent** (40183 symbols, 70810 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
