...
This project is indexed by GitNexus as **spark-agent** (59810 symbols, 108753 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
