...
This project is indexed by GitNexus as **spark-agent** (5217 symbols, 10583 relationships, 294 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
