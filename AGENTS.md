...
This project is indexed by GitNexus as **spark-agent** (24357 symbols, 43391 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
