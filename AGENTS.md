...
This project is indexed by GitNexus as **spark-agent** (60701 symbols, 108578 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
