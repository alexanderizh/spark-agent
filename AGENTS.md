...
This project is indexed by GitNexus as **spark-agent** (60541 symbols, 108263 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
