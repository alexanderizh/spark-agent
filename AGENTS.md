...
This project is indexed by GitNexus as **spark-agent** (35855 symbols, 63151 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
