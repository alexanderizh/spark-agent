...
This project is indexed by GitNexus as **spark-agent** (14378 symbols, 32935 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
