...
This project is indexed by GitNexus as **spark-agent** (42020 symbols, 73611 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
