...
This project is indexed by GitNexus as **spark-agent** (11901 symbols, 25818 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
