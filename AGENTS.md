...
This project is indexed by GitNexus as **spark-agent** (24138 symbols, 43330 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
