...
This project is indexed by GitNexus as **spark-agent** (76609 symbols, 138458 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
