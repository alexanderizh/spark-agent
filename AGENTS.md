...
This project is indexed by GitNexus as **spark-agent** (37233 symbols, 63594 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
