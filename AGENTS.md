...
This project is indexed by GitNexus as **spark-agent** (22063 symbols, 39296 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
