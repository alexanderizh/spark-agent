...
This project is indexed by GitNexus as **spark-agent** (35893 symbols, 63206 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
