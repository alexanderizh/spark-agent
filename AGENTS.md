...
This project is indexed by GitNexus as **spark-agent** (59126 symbols, 105025 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
