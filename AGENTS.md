...
This project is indexed by GitNexus as **spark-agent** (36303 symbols, 61999 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
