...
This project is indexed by GitNexus as **spark-agent** (30881 symbols, 55382 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
