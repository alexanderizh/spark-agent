...
This project is indexed by GitNexus as **spark-agent** (19838 symbols, 44460 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
