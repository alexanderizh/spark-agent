...
This project is indexed by GitNexus as **spark-agent** (73181 symbols, 132357 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
