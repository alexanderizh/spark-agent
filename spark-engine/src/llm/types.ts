...
/**
 * User-facing reasoning-effort levels shared by the CLI flag, the TUI picker,
 * and the LLM request mapping. `off` disables thinking entirely; `max` is the
 * largest budget the protocols accept (OpenAI's coarse scale coarsens it to
 * high).
 */
