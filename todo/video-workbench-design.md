...
> 2026-07-14 核对：工作台已具备视频监看、关键帧、裁片、分段、转码、变速、倒放、画面裁剪和产物列表；V1 时间轴已支持直接拖拽修剪、I/O 入出点、播放头分割、快切/精切导出，并补充“素材分析 → 剪辑处理 → 产物检查”阶段导航及工作台内 FFmpeg 安装。字幕、水印、多视频拼接和多轨时间线仍属于后续范围。
