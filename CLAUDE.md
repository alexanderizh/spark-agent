...
This project is indexed by GitNexus as **spark-agent** (86021 symbols, 161367 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
