...
This project is indexed by GitNexus as **spark-agent** (27722 symbols, 49829 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
