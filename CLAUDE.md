...
This project is indexed by GitNexus as **spark-agent** (9067 symbols, 14608 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
