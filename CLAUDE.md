...
This project is indexed by GitNexus as **spark-agent** (65546 symbols, 118076 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
