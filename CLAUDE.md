...
This project is indexed by GitNexus as **spark-agent** (80185 symbols, 149184 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
