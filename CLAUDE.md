...
This project is indexed by GitNexus as **spark-agent** (14141 symbols, 28211 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
