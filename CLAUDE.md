...
This project is indexed by GitNexus as **spark-agent** (35705 symbols, 61066 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
