...
This project is indexed by GitNexus as **spark-agent** (53528 symbols, 95456 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
