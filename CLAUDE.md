...
This project is indexed by GitNexus as **spark-agent** (41902 symbols, 73421 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
