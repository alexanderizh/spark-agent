...
This project is indexed by GitNexus as **spark-agent** (44942 symbols, 78463 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
