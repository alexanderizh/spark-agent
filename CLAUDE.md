...
This project is indexed by GitNexus as **spark-agent** (4225 symbols, 8609 relationships, 225 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
