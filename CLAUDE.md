...
This project is indexed by GitNexus as **spark-agent** (11819 symbols, 26243 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
