...
This project is indexed by GitNexus as **spark-agent** (16238 symbols, 37660 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
