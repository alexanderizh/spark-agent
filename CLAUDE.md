...
This project is indexed by GitNexus as **spark-agent** (56592 symbols, 100615 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
