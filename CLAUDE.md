...
This project is indexed by GitNexus as **spark-agent** (25673 symbols, 45893 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
