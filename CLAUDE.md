...
This project is indexed by GitNexus as **spark-agent** (14492 symbols, 30769 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
