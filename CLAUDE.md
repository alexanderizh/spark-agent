...
This project is indexed by GitNexus as **spark-agent** (43970 symbols, 76865 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
