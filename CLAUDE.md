...
This project is indexed by GitNexus as **spark-agent** (45515 symbols, 79496 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
