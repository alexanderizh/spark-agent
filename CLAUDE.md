...
This project is indexed by GitNexus as **spark-agent** (2972 symbols, 6117 relationships, 179 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
