...
This project is indexed by GitNexus as **spark-agent** (41972 symbols, 73520 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
