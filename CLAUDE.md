...
This project is indexed by GitNexus as **spark-agent** (41511 symbols, 72818 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
