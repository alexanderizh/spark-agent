...
This project is indexed by GitNexus as **spark-agent** (25698 symbols, 45946 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
