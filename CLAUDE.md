...
This project is indexed by GitNexus as **spark-agent** (4250 symbols, 8632 relationships, 222 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
