...
This project is indexed by GitNexus as **spark-agent** (9505 symbols, 21742 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
