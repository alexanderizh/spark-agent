...
This project is indexed by GitNexus as **spark-agent** (12184 symbols, 22414 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
