...
This project is indexed by GitNexus as **spark-agent** (7217 symbols, 14026 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
