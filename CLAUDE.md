...
This project is indexed by GitNexus as **spark-agent** (5180 symbols, 10415 relationships, 249 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
