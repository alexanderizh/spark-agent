...
This project is indexed by GitNexus as **spark-agent** (50427 symbols, 89703 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
