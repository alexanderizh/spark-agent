...
This project is indexed by GitNexus as **spark-agent** (16829 symbols, 38880 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
