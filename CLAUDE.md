...
This project is indexed by GitNexus as **spark-agent** (76286 symbols, 137972 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
