...
This project is indexed by GitNexus as **spark-agent** (44365 symbols, 77447 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
