...
This project is indexed by GitNexus as **spark-agent** (31132 symbols, 55775 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
