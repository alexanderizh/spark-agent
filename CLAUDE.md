...
This project is indexed by GitNexus as **spark-agent** (39163 symbols, 68679 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
