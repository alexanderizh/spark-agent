...
This project is indexed by GitNexus as **spark-agent** (15026 symbols, 30940 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
