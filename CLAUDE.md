...
This project is indexed by GitNexus as **spark-agent** (42377 symbols, 74236 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
