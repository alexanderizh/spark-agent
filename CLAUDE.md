...
This project is indexed by GitNexus as **spark-agent** (5100 symbols, 10335 relationships, 284 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
