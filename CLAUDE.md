...
This project is indexed by GitNexus as **spark-agent** (22420 symbols, 39911 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
