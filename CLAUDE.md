...
This project is indexed by GitNexus as **spark-agent** (71413 symbols, 129320 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
