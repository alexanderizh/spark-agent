...
This project is indexed by GitNexus as **spark-agent** (54301 symbols, 96624 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
