...
describe('resolveProfileMediaModels', () => {
  ...
  it('ref.defaults 按能力声明键叠加进 capability.defaults，未声明键不污染', () => {
    const catalog = newCatalog()
    const manifest: MediaModelManifest = {
      ...
      capabilities: [
        {
          ...
          paramSchema: {
            type: 'object',
            properties: { size: { type: 'string', enum: ['1:1', '16:9'] } },
          },
          defaults: { size: '1:1' },
        },
        {
          ...
          paramSchema: {
            type: 'object',
            properties: { editStrength: { type: 'number', minimum: 0, maximum: 1 } },
          },
        },
      ],
      invocation: {
      ...
      docs: { sourceUrls: ['https://example.com/docs'] },
    }
        ...
        mediaModelRefs: [
          {
            ...
            manifest,
            defaults: { size: '16:9', editStrength: 0.8, watermark: true },
          },
        ],
      },
      catalog,
