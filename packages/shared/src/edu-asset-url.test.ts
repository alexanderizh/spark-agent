...
describe('normalizeEduAssetUrl', () => {
  it('adds /edu-prod for production upload assets', () => {
    ...
    ).toBe('https://spark.yiqibyte.com/edu-prod/uploads/raw/6768ff07-d673-4fe8-8089-a992350a39c0.png')
  })

  it('keeps already-correct production URLs unchanged', () => {
    expect(
      normalizeEduAssetUrl('https://spark.yiqibyte.com/edu-prod/uploads/raw/6768ff07-d673-4fe8-8089-a992350a39c0.png'),
    ).toBe('https://spark.yiqibyte.com/edu-prod/uploads/raw/6768ff07-d673-4fe8-8089-a992350a39c0.png')
  })
