...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  },
  {
    ...
    mediaDefaults: {
      image: { size: 'auto', quality: 'auto', n: 1, outputFormat: 'png' },
    },
    sourceUrls: [
  ...
  /* ─── Google Gemini / Veo / Omni ─── */
  {
    ...
    mediaModelRefs: [
      {
        manifestId: 'google-generative-ai:gemini-3.1-flash-image',
        modelId: 'gemini-3.1-flash-image',
        enabled: true,
      },
      {
        manifestId: 'google-generative-ai:gemini-3.1-flash-lite-image',
        modelId: 'gemini-3.1-flash-lite-image',
        enabled: true,
      },
      {
        manifestId: 'google-generative-ai:gemini-3-pro-image',
        modelId: 'gemini-3-pro-image',
        enabled: true,
      },
      {
        manifestId: 'google-generative-ai:gemini-2.5-flash-image',
      ...
      ...[
        ...
        manifestId: `google-generative-ai:${modelId}`,
        modelId,
        enabled: true,
      })),
    ],
...

  {
    ...
    modelIds: ['lyria-3-clip-preview', 'lyria-3-pro-preview'],
    modelType: 'voice',
    mediaProvider: 'google-generative-ai',
    mediaApiType: 'sync',
    mediaCapabilities: ['audio.music'],
    mediaModelRefs: ['lyria-3-clip-preview', 'lyria-3-pro-preview'].map((modelId) => ({
      manifestId: `google-generative-ai:${modelId}`,
      modelId,
      enabled: true,
    })),
    mediaDefaults: { audio: { format: 'mp3' } },
    sourceUrls: ['https://ai.google.dev/gemini-api/docs/music-generation'],
  },
