...
const contentClassName = [
  'z-[var(--z-dropdown)] min-w-40 overflow-hidden rounded-md',
...
>(({ className, inset, danger, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      itemClassName,
      inset && 'pl-8',
      danger && 'text-danger hover:bg-danger-bg hover:text-danger focus:bg-danger-bg focus:text-danger',
      className,
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-[var(--font-xs)] font-medium text-text-faint', inset && 'pl-8', className)}
    {...props}
  />
))
